...
export default class Form2 extends Component {
    ...
    deleteuser=(usr , id)=>{
        ...
        console.log(usr ,id)
        console.log(number);
        axios.delete('http://localhost:3004/user2/'+ number).then((res)=>{
    ...
    updateuser=()=>{
        ...
        axios({
            method:'put',
            url:'http://localhost:3004/user2/'+number,
            data: this.state.person
        })
    ...
    async componentDidMount(){
        let displayusers = await axios.get('http://localhost:3004/user2/')
